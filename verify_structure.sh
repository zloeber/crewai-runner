...
grep -q '^@router\.get("", ' api/routers/providers.py && echo "✓ GET /providers" || echo "✗ GET /providers"
grep -q '^@router\.post("", ' api/routers/providers.py && echo "✓ POST /providers" || echo "✗ POST /providers"
grep -q '^@router\.get("", ' api/routers/models.py && echo "✓ GET /models" || echo "✗ GET /models"
grep -q '^@router\.post("", ' api/routers/models.py && echo "✓ POST /models" || echo "✗ POST /models"
grep -q '^@router\.post("/start", ' api/routers/workflows.py && echo "✓ POST /workflows/start" || echo "✗ POST /workflows/start"
grep -q '^@router\.post("/stop", ' api/routers/workflows.py && echo "✓ POST /workflows/stop" || echo "✗ POST /workflows/stop"
grep -q '^@router\.get("/{workflowId}/status", ' api/routers/workflows.py && echo "✓ GET /workflows/{workflowId}/status" || echo "✗ GET /workflows/{workflowId}/status"
grep -q '^@router\.post("", ' api/routers/chat.py && echo "✓ POST /chat" || echo "✗ POST /chat"
grep -q '^@router\.post("/validate", ' api/routers/yaml_validator.py && echo "✓ POST /yaml/validate" || echo "✗ POST /yaml/validate"
