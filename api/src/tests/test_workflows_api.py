...
@pytest.mark.asyncio
async def test_start_workflow_success(api_client, sample_workflow_config, mock_orchestrator_factory, skip_if_no_server):
...
@pytest.mark.asyncio 
async def test_start_workflow_with_provider_config(api_client, sample_workflow_config, mock_orchestrator_factory, skip_if_no_server):
...
@pytest.mark.asyncio
async def test_start_workflow_unsupported_framework(api_client, sample_workflow_config, skip_if_no_server):
    ...
    with patch("routers.workflows.OrchestratorFactory") as mock:
        mock.get_orchestrator.side_effect = ValueError("Framework not supported")
        ...
        assert "Framework not supported" in response.json()["detail"]


@pytest.mark.asyncio
async def test_start_workflow_execution_error(api_client, sample_workflow_config, skip_if_no_server):
...
@pytest.mark.asyncio
async def test_stop_workflow_success(api_client, sample_workflow_config, mock_orchestrator_factory, skip_if_no_server):
...
@pytest.mark.asyncio
async def test_stop_workflow_orchestrator_error(api_client, sample_workflow_config, mock_orchestrator_factory, skip_if_no_server):
...
@pytest.mark.asyncio
async def test_get_workflow_status_success(api_client, sample_workflow_config, mock_orchestrator_factory, skip_if_no_server):
...
@pytest.mark.asyncio
async def test_get_supported_frameworks(api_client, mock_orchestrator_factory, skip_if_no_server):
...
@pytest.mark.asyncio
async def test_start_workflow_default_framework(api_client, sample_workflow_config, mock_orchestrator_factory, skip_if_no_server):
...
@pytest.mark.asyncio
async def test_start_workflow_framework_from_workflow_config(api_client, sample_workflow_config, mock_orchestrator_factory, skip_if_no_server):
