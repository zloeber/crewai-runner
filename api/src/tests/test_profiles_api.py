...
@pytest.mark.asyncio
async def test_list_profiles_with_data(api_client, mock_profiles_dir, sample_profile_config, skip_if_no_server):
...
@pytest.mark.asyncio
async def test_list_profiles_skip_invalid(api_client, mock_profiles_dir, skip_if_no_server):
    ...
    sample_config = {
        "metadata": {"name": "valid", "description": "Valid profile"}
    }
...
@pytest.mark.asyncio
async def test_load_profile_success(api_client, mock_profiles_dir, sample_profile_config, skip_if_no_server):
...
async def test_load_profile_not_found(api_client, mock_profiles_dir, skip_if_no_server):
    ...
    assert "Profile 'non-existent' not found" in response.json()["detail"]


@pytest.mark.asyncio
async def test_load_profile_invalid_yaml(api_client, mock_profiles_dir, skip_if_no_server):
...
@pytest.mark.asyncio
async def test_save_profile_new(api_client, mock_profiles_dir, sample_profile_config, skip_if_no_server):
    """Test saving a new profile via HTTP with Bearer token authentication."""
    request_data = {
        "profile": sample_profile_config,
        "overwrite": False
    }
...
@pytest.mark.asyncio
async def test_save_profile_overwrite_existing(api_client, mock_profiles_dir, sample_profile_config, skip_if_no_server):
...
@pytest.mark.asyncio
async def test_save_profile_conflict(api_client, mock_profiles_dir, sample_profile_config, skip_if_no_server):
...
@pytest.mark.asyncio
async def test_delete_profile_success(api_client, mock_profiles_dir, sample_profile_config, skip_if_no_server):
...
@pytest.mark.asyncio
async def test_delete_profile_not_found(api_client, mock_profiles_dir, skip_if_no_server):
...
@pytest.mark.asyncio
async def test_export_profile_success(api_client, mock_profiles_dir, sample_profile_config, skip_if_no_server):
...
@pytest.mark.asyncio
async def test_export_profile_not_found(api_client, mock_profiles_dir, skip_if_no_server):
...
@pytest.mark.asyncio
async def test_import_profile_success(api_client, mock_profiles_dir, sample_profile_config, skip_if_no_server):
...
@pytest.mark.asyncio
async def test_import_profile_invalid_yaml(api_client, mock_profiles_dir, skip_if_no_server):
    ...
    assert response.status_code == 400
    assert "Invalid YAML content" in response.json()["detail"]


@pytest.mark.asyncio
async def test_import_profile_overwrite(api_client, mock_profiles_dir, sample_profile_config, skip_if_no_server):
...
@pytest.mark.asyncio
async def test_get_profile_alternative_endpoint(api_client, mock_profiles_dir, sample_profile_config, skip_if_no_server):
...
@pytest.mark.asyncio
async def test_get_profile_not_found_alternative(api_client, mock_profiles_dir, skip_if_no_server):
...
@pytest.mark.asyncio
async def test_save_profile_updates_created_timestamp(api_client, mock_profiles_dir, skip_if_no_server):
